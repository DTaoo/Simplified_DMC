...
def location_model_eva(model, data_loader):
    ...
    pickle.dump(results, open('dmc_syn.pkl', 'wb'))
    return accs / count
...
def main():
    ...
    # test_list_file = os.path.join(args.data_list_dir, 'duet_pairs_val.txt')
...
#    test_dataset = MUSIC_Dataset(args_test)
